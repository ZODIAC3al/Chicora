        ...
        >
            ...
            {filteredServices.length === 0 && !loading && (
                ...
                >
                    ...
                    <h3 className="text-xl font-medium text-gray-800 mb-2">{t('services.noServicesTitle')}</h3>
                    <p className="text-gray-600 max-w-md mx-auto mb-6">{t('services.noServicesDescription')}</p>
                    <button 
